...
if __name__=="__main__":
  ...
  if sys.path[0]:
    ...
    #sys.path.append( "/usr/apps/python/lib/python2.7/site-packages" )

  os.environ['GDFONTPATH'] = '/usr/gapps/ats/ASC/fonts'

  from atsASC.checkers.modules.UltraCheck import UltraCheckBase

  class UltraCheck106(UltraCheckBase):
    def dummy(self):
      pass


  checker = UltraCheck106()

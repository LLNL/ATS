...
if __name__ == "__main__":
    code = os.path.join(KRIPKE_PATH,
                        'kripke-v1.2.6-1-g0d24be5/build/bin/kripke.exe')
    ...
    code_args = [
        '--layout dgz --niter 100 ',
        '--layout dzg --niter 100 ',
        '--layout gdz --niter 100 ',
        '--layout gzd --niter 100 ',
        '--layout zdg --niter 100 ',
        '--layout zgd --niter 100 ',
        '--layout dgz --niter 100 --pmethod bj',
    ]
